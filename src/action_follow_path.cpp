...
BT::NodeStatus NavLiteFollowPathAction::tick()
{
  ...
  send_goal_options.goal_response_callback =
      std::bind(&NavLiteFollowPathAction::goal_response_callback, this, _1);
  send_goal_options.feedback_callback =
      std::bind(&NavLiteFollowPathAction::feedback_callback, this, _1, _2);
  send_goal_options.result_callback =
      std::bind(&NavLiteFollowPathAction::result_callback, this, _1);
...
void NavLiteFollowPathAction::cleanup() 
{
...
void NavLiteFollowPathAction::halt() 
{
...
void NavLiteFollowPathAction::goal_response_callback(std::shared_future<GoalHandleFollowPath::SharedPtr> future)
  {
  ...
  void NavLiteFollowPathAction::feedback_callback(
  ...
  void NavLiteFollowPathAction::result_callback(const GoalHandleFollowPath::WrappedResult & result)
  {
    switch (result.code) {
